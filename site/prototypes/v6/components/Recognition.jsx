...
V6.Recognition = function Recognition() {
  return (
    <div className="page">
      <header>
        <h1>Recognition</h1>
        <p className="positioning">Awards the field gives for work that holds up,
          several of them a decade after publication. And thirteen granted U.S.
          patents in automated software engineering.</p>
      </header>
