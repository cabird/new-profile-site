...
const { TopNav, Footer, Icon, fetchPapers, parseTags, venueOf, fmtAuthors } = V5;
...
V5.MarkdownView = function MarkdownView({ paperId }) {
...
V5.BibtexView = function BibtexView({ bibtex }) {
...
V5.PubRow = function PubRow({ p }) {
  const { MarkdownView, BibtexView } = V5;
