...
![Table showing breakdown of interview participants by discipline, level, and number interviewed](page3_img_1.png)

> **Image description:** A three-column table showing the disciplines interviewed, their level of seniority, and the number of people interviewed in each cell. Software Engineers are the largest group: Entry Level 4, Senior 1, Principal and Above 4, Manager 5, Upper Management 11 (25 total). Product Managers appear as Principal and Above 3, Manager 3, Upper Management 11 (17 total); additional participants include Designer (Principal and Above: 2), Data Science (Principal and Above: 1), and Architect (Principal and Above: 3). The table entries sum to 48 interviewees, while the paper text reports 47 interviews, indicating a one-person discrepancy.
...
### Survey
We sent the survey to approximately 4,000 employees within the organization we were studying. We used a direct email from the authors' email account with a Qualtrics link to solicit responses. We left the survey open for 15 days and reminded individuals once to submit their surveys after 11 days. We had a survey response rate of approximately 13% and received 512 responses. This response rate is in line with other surveys in software engineering research [31].

The survey was advertised to take 15–20 minutes to complete and most participants finished within this time. After completion of the survey, participants could enter a sweepstakes to win one of four US $100 gift certificates, as such rewards have been found to improve response rates [33].

The survey included questions about the following aspects:
- Demographics (discipline, career stage, experience, region)
- Employee engagement and satisfaction (19 items), i.e., how employees feel about their work, how they perceive their rewards and recognition, and their level of autonomy. Example items are “Most days I am excited to come to work to do my job”, “My work creates value for customers”, and “I am rewarded based on the impact of my contributions to business outcomes”.
- Team culture (9 items), i.e., the values of open communication, teamwork, and alignment with organizational goals within a team. Example items are “On my team, new ideas are welcomed”, “On my team, we are focused on a unified mission”, and “On my team we are willing to embrace change”.
- OKR Maturity (6 items), i.e., how effective the team is at activities related to goal setting.
- Modern engineering practices (7 items), i.e., how modern the engineering practices of the team are.
- Activities related to goal setting
- Communication channels related to goal setting
- Time spent on decision making and goal setting
- Open-ended questions related to challenges, benefits, and improvements with goal setting.

The full survey instrument including all questions and all items is available as supplemental materials [5].

## 4.3 Data Analysis

### Interviews
After the interviews, we reviewed the transcripts and recordings for repeated themes. Once we had exhausted theme identification, we categorized which themes appeared in which interviews. We recorded all themes that came up unsolicited in at least two interviews. The list of these themes is presented in the results in Section 5.

## 5 GOOD OKR PRACTICES

### 5.1 Interview Themes
The top themes that were seen in interviews of people both within the organization and those that work with the organization were the following:
- Decision making
- Moving together as a broad organization and working across teams
- Optimization questions (such as local vs global optimization in a large organization)
- Clarity of goals, mission and alignment between teams
- Technical debates (such as writing shareable code vs getting it done quickly, using existing libraries vs writing our own, etc)
...
### 5.2 OKR Maturity and Experience, Work Culture, and Agile Methodology
The first set of questions on the survey included demographic information such as gender, length of time at the company, length of time in the organization, length of time in the software industry
...
![Bar chart: Top challenges faced when working with OKRs and goals](page7_img_1.png)

> **Image description:** Horizontal bar chart showing the frequency with which survey respondents mentioned particular challenges when working with OKRs. The most-cited problem is “Creating OKRs/Goals” (about 35–40% of responses), followed by “Data Issues” (roughly 20–25%). Other commonly reported challenges include “Working With Others,” “Priorities,” and “Alignment, Accountability, Clarity & Transparency” (each ≈15–18%), with “Lack of Process,” “Overall Frustration,” “Goals Across Levels,” and “Goal Review & Communication” mentioned less often (roughly 8–15% each). The figure visualizes open-text themes from the survey, and totals exceed 100% because respondents could report multiple challenges.
...
are working on, this could lead to them being held accountable for that, and people did not necessarily want that. Without clear commitment from the leadership of what the priorities are and that they will be stuck to, sticking to priorities at a lower level felt futile.
...
- Invest in the data pipeline
- Increase transparency
- Improve communication
- Promote learning communities
- Guide the process

### 7.1 Invest in the Data Pipeline
...
Many engineering teams already use software for tracking their work (such as Azure DevOps) and have other work-specific tools. Engineers are also very good at finding, or even building, creative solutions to problems. As such, implementing an OKR framework with a large group of software engineers without careful rollout and tooling will let a thousand flowers bloom — teams will find their own, creative, unique way to use this process. In these cases, problems such as a lack of clarity and alignment, difficulty setting and sharing out goals, challenges working with other teams, and shifting priorities are bound to come up.

Rather, in order to successfully use OKRs in the software industry, managers need to be properly trained on the framework; learnings need to be shared and consistent; data needs to be accessible; and goals at all levels need to be transparent and clearly communicated. When teams have a high OKR maturity, they are able to set and measure goals well, as well as reflect on progress towards goals and change course as needed. This maturity is correlated with other desirable skills for software engineers, including creativity, team commitment to organizational priorities, enjoying the work they are doing and being overall happy at the company (including a decreased desire to leave). In addition, having a unified mission as a team and valuing creativity are correlated with both high OKR maturity and more modern development practices, something many existing software engineering teams are trying to pivot to. It is clear that objectives and key results can be beneficial for software engineering teams when used consistently across teams and organizations.

## ACKNOWLEDGMENTS

We thank all participants in the interviews and the survey for their insightful comments on working with OKRs and goals. We would also like to thank Paul Bennett, Nicole Forsgren, Cory Hilke, Ales Holecek, Ron Pessner, Josh Pollock, David Speirs, Jaime Teevan, and Igor Zaika as well as the entire SAINTES team for their constructive and insightful feedback throughout all stages of this project. The ethics for this study were reviewed and approved by the Microsoft Research Institutional Review Board (MSRIRB), which is an IRB federally registered with the United States Department of Health & Human Services.

## REFERENCES

[1] 2022. How agile teams make Objectives and Key Results (OKRs) work. Pittsburgh, PA, USA.

[2] 2022. Using Objectives and Key Results (OKRs) and Slack: A Case Study of Coordination in Large-Scale Distributed Agile. Hawaii, USA.
...
[4] Betterworks. 2016. How Employee Alignment Boosts the Bottom Line. Technical Report. Harvard Business Review.

[5] Jenna Butler, Thomas Zimmermann, and Christian Bird. 2023. Supplemental Material for “Objectives and Key Results in Software Teams: Challenges, Opportunities and Impact on Development”. https://doi.org/10.5281/zenodo.8409170

[6] Ruixia Cao. 2021. Research on Teaching Evaluation System of Higher Vocational Colleges Based on OKR and Big Data. International Conference on Computer Science & Education (2021).

[7] Chayapol Charoenlarpkul and Somchai Tantasanee. 2019. A Proposed Employee Development Program From Objectives and Key Results: A Case Study of SG Group of Companies. ABAC ODI Journal 6 (2019). Issue 2.

[8] James M. Conway and Charles E. Lance. 2010. What reviewers should expect from authors regarding common method bias in organizational research. Journal of Business and Psychology 25 (2010), 325–334.

[9] John Doerr. 2018. Measure What Matters. Portfolio/Penguin, New York, NY.

[10] Stewart I. Donaldson and Elisa J. Grant-Vallone. 2002. Understanding self-report bias in organizational behavior research. Journal of Business and Psychology 17 (2002), 245–260.

[11] Peter Drucker. 1954. The Practice of Management.

[12] Matteo Ferrazzi. 2021. Objectives and key results as a tool for organizational agility: the case study of digital start-ups.

[13] Bent Flyvbjerg. 2006. Five misunderstandings about case-study research. Qualitative Inquiry 12, 2 (2006), 219–245.

[14] A. L. Da Fonseca. 2018. Objectives and Key Results in the classroom: a framework for practice development on goal-setting. Master’s thesis. University of Oxford.

[15] Henry Ford. 1926. Encyclopedia Britannica (1926).

[16] Anthony D. Fredricks. 2021. Why Failing Is Necessary for Creativity.

[17] Doug Gray. 2019. Objectives and Key Results (OKR) Leadership: How to Apply Silicon Valley’s Secret Sauce to Your Career, Team or Organization. Action Learning Associates, LLC.

[18] Pureheart Ogheneogaga IRIKEFE. 2021. Effect of Objectives and Key Results (OKR) on Organisational Performance in the Hospitality Industry. International Journal of Research Publications (2021).

[19] Eirini Kalliamvakou, Christian Bird, Thomas Zimmermann, Andrew Begel, Robert DeLine, and Daniel M. German. 2019. What Makes a Great Manager of Software Engineers? IEEE Transactions on Software Engineering 45, 1 (January 2019), 87–106.

[20] Robert S. Kaplan and David P. Norton. 2000. The Strategy-Focused Organization. Vol. 1. Harvard Business Review Press.

[21] Adam Kuper and Jessica Kuper. 1985. The Social Science Encyclopaedia. Cambridge University Press.

[22] Ben Lamorte. 2022. The OKRs Field Book: A Step-by-Step Guide for Objectives and Key Results Coaches. Wiley.

[23] Edwin A. Locke. 1968. Toward a theory of task motivation and incentives. Organizational Behavior and Human Performance 3 (1968), 157–189. Issue 2.

[24] Mruthyanjaya Rao Mangipudi, KDV Prasad, and Rajesh W. Vaidya. 2021. Objectives and Key Results for Higher Education Institutions - A Blended Approaches Part of Post Covid-19 Initiatives for Keeping the Institutions Abreast of the Industry Innovations, Create Future Leaders and Build the Nation. Pacific Business Review International 13 (March 2021). Issue 9.

[25] Mruthyanjaya Rao Mangipudy, KDV Prasad, and Rajesh W. Vaidya. 2021. Objectives and Key Results for Higher Education Institutions - A Blended Approaches Part of Post Covid-19 Initiatives for Keeping Institutions Abreast of the Industry Innovations, Create Future Leaders and Build the Nation. Pacific Business Review International 13 (2021). Issue 9.

[26] Nils Brede Moe, Bjorn Dahl, and Viktoria Stray. 2019. Team autonomy in large-scale agile. Proceedings of the 52nd Hawaii International Conference on Systems Science (2019).

[27] Paul R. Niven and Ben Lamorte. 2016. Objectives and Key Results. John Wiley and Sons, Hoboken, NJ.

[28] Jordan Novet. [n.d.]. Microsoft acquires Ally.io as productivity software gains importance in era of remote work. https://www.cnbc.com/2021/10/07/microsoft-acquires-allyio-will-add-it-to-viva.html

[29] Maria Paasivaara, Casper Lassenius, and Ville T. Heikkila. 2012. Inter-team coordination in large-scale globally distributed scrum: Do scrum-of-scrums really work? Proceedings of the ACM-IEEE international symposium on Empirical Software Engineering and Measurement (2012), 235–238.

[30] Philip M. Podsakoff, Scott B. MacKenzie, Jeong-Yeon Lee, and Nathan P. Podsakoff. 2003. Common method biases in behavioral research: a critical review of the literature and recommended remedies. Journal of Applied Psychology 88, 5 (2003), 879.
...
[32] Robert Rodgers and John E. Hunter. 1991. Impact of Management by Objectives on Organizational Productivity. Journal of the American Psychological Association (1991).

---

## Objectives and Key Results in Software Teams

[33] Edward Smith, Robert Loftin, Emerson Murphy-Hill, Christian Bird, and Thomas Zimmermann. 2013. Improving developer participation rates in surveys. In 2013 6th International Workshop on Cooperative and Human Aspects of Software Engineering (CHASE). IEEE, 89–92.

[34] Frederick Winslow Taylor. 1911. Principles of Scientific Management.

[35] Bianca Trinkenreich, Gleison Santos, Monalessa Perini Barcellos, and Tayana Conte. 2019. Combining GQM+ strategies and OKR — Preliminary results from a Participative Case Study in Industry. 20th International Conference on Product-Focused Software Process Improvement (2019).

[36] Bianca Trinkenreich, Gleison Santos, Monalessa Perini Barcellos, and Tayana Conte. 2019. Combining GQM+ strategies and OKR — preliminary results from a participative case study in industry. International Conference on Product-Focused Software Process Improvement (2019), 103–111.

[37] Vetri Vellore. 2022. OKRs for all: Making objectives and key results work for your entire organization. John Wiley & Sons.

[38] Tong Xia, Sumit Bhardwaj, Pavel Dmitriev, and Aleksander Fabijan. 2019. Safe Velocity: A Practical Guide to Software Deployment at Scale using Control Rollout. International Conference on Software Engineering: Software Engineering in Practice (2019).

[39] Hao Zhou and Yu-Ling He. 2017. Comparative Study of OKR and KPI. International Conference on E-Commerce and Contemporary Economic Development (ECED) (2017), 319–323.