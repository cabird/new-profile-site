...
> **Image description:** A decision tree built from 843 power spikes with the root average of 112.1 mW (n=843). The first split is on Mills.dll: when Mills.dll is absent (n=814) the average is 92.5 mW, while when Mills.dll is present (n=29) the average jumps to 664.6 mW (~6× higher). The Mills-absent branch further splits on Leveson.dll (present: n=795, 85.9 mW; absent: n=19, 366.3 mW), and the Leveson-present node splits on Hamming.dll (Hamming absent: n=774, 72.8 mW; Hamming present: n=21, 202.0 mW), showing how combinations of module presence are associated with stepwise increases in average power consumption.
