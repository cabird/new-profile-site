...
[Image: page7_img_1.png] A color‑coded bar chart (Figure 2) shows the percentage of the 155 Gamasutra postmortems that mention each topic under “What went right.” The most frequently cited strengths were Game Design (≈50%), Development Process (≈43%), Team (≈40%), and Art (≈39%), while other commonly noted positives include Tools, Testing, Gameplay and Features. Bars are grouped and colored by high‑level category (Product in maroon, Development in blue, Resources in pale yellow, Customer‑Facing in light blue, plus Other in black); values do not sum to 100% because each postmortem lists multiple items. Less frequently listed positives include Documentation, Product Evolution and Hardware, which have very small bars near the bottom of the axis.
