...
> **Image description:** Screenshot of the first page of a Gamasutra postmortem titled “Postmortem: Pangalore’s Knightly Adventure” (by Doyon Kim). The image shows the Gamasutra header and a right-side feature artwork, followed by an introductory paragraph and the two main sections used throughout the paper’s dataset: “What Went Right” (with a numbered item “It’s Two, Two Things in One”) and “What Went Wrong” (with a numbered item “Multiplatform Launch Out of Sync”). The paper cites this figure as an example of the typical multi-page postmortems they analyzed, illustrating the consistent structure (context, what went right/ wrong, and metadata) used to extract categories and themes.
...
Length of Development: The majority of projects were developed in less than 2 years. Of the 73% of developers who put the length of development in their postmortem reviews, 39% of the games were developed in 1–2 years and 38% were developed in 1 year or less.
...
#### (a) Art
Game art is a contributing factor to the overall quality of a game. Items that can go right or wrong within this category include artist skill, art development process, art quality, the effect of art on gameplay, and the effect of art on user experience.
...
#### (b) Creativity
The creativity of the development team is often a main factor in the success or failure of a game.

Example of what went right: According to Wim Coveliers, during the making of American McGee’s Grimm, Spicy Horse did “a great job at keeping creative thinking alive throughout the whole project.” They were able to inject large amounts of creative content into their game by encouraging an open dialog within their company. They encouraged anyone with an idea to come forward and lead a discussion. Decisions were made by a democratic vote, to prevent any one person from taking control of the game.
...
#### (e) Gameplay
How players interact with the game often determines how easily they will learn the controls as well as how entertaining it is for them.
...
### (f) Product Evolution
Software evolution in general indicates the changes happening in the software over time. In our study we link product evolution to those cases where the games evolve from one idea into another idea.
...
The process teams use while developing always affects the quality of the product. This was one of the more common categories that developers often listed in their postmortems.
...
### (c) Obstacles
Teams often face obstacles during development. A situation will arise which makes it difficult for the team to continue development, and how the team reacts when faced with obstacles will impact their product for better or for worse. Obstacles are more likely to have a negative impact on a team.
...
#### (d) Team
Generally, developers had positive experiences with their teams. However, some teams do have trouble during development.

Example of what went right: During the development of Dungeon Siege, Bartosz Kijanka of Gas Powered Games described the development team as “the single best thing about Dungeon Siege.” They attribute this to the individuals’ strong values, personalities, and respect.
...
#### (e) Testing
Developers put testing down under what went right when they performed some kind of testing during development such as unit/alpha/beta/usability testing, etc. When developers listed testing as something that went wrong, they generally suffered from a lack of testing.
...
#### (f) Tools
The tools you utilize to develop a game often impact the ease of development, the complexity of the features, and the quality of the end product.
...
#### (c) Publisher Relations
If a developer chose to work with a publisher, then they often experienced benefits or drawbacks from that relationship. In general, those who listed items in this category in their postmortems had good relationships with their publisher.
...
Example of what went wrong: Brian Reynolds of Big Huge Games described the developing of Rise of Nations. They underestimated their schedule, which made them work long hours later on in the project. Reynolds stated that "We underestimated the amount of coding time necessary, which resulted in an extremely overworked programming staff." Additionally, they overloaded their lead programmer, making him a bottleneck for development. They also did not hire enough programmers to start. They stated that the root of their mistake was not listening to the postmortem reviews they had read in the Game Developer magazine.
...
### (a) Community Support
The support of a community can greatly benefit any game, whether it be an online community spreading the word about your game, or a group of outside individuals who lend a helping hand during development. Other aspects of community support that can go right or wrong for a team are the presence or lack of an online community, publicity by users of message boards, and a loyal fan base. We found that developers listed this as something that went well during development rather than something that went wrong.

*Example of what went right:* Art Min of game developer Multitude said that they created tools for the community to utilize within their game lobby and community website during the making of Fireteam. They stated that "Players are not only a source of revenue for a project, but they are a feature of your game." They argue that when players of a game develop a sense of community, it's like adding a whole other feature to that game.
...
### (d) Piracy/Licensing
Piracy and licensing has always been an issue in the gaming industry. Whether it be a game losing sales because of piracy, or a lack of quality music because the developer couldn't get the license.

---

![Bar chart showing percentages for categories that went right](page7_img_1.png)

> **Image description:** A color‑coded bar chart (Figure 2) shows the percentage of the 155 Gamasutra postmortems that mention each topic under “What went right.” The most frequently cited strengths were Game Design (≈50%), Development Process (≈43%), Team (≈40%), and Art (≈39%), while other commonly noted positives include Tools, Testing, Gameplay and Features. Bars are grouped and colored by high‑level category (Product in maroon, Development in blue, Resources in pale yellow, Customer‑Facing in light blue, plus Other in black); values do not sum to 100% because each postmortem lists multiple items. Less frequently listed positives include Documentation, Product Evolution and Hardware, which have very small bars near the bottom of the axis.
...
![Bar chart showing categories of what went wrong](page8_img_1.png)

> **Image description:** A vertical bar chart (Figure 3) reports the percentage of the analyzed Gamasutra postmortems that list each category as something that went wrong; the y‑axis is “Percentage of Postmortems” and the x‑axis lists 22 specific categories. Bars are color coded by higher‑level groups (maroon = Product, blue = Development, pale yellow = Resources, light blue = Customer‑facing, black = Other). The four most frequently cited pitfalls are Obstacles (≈37%), Schedule (≈25%), Development Process (≈24%), and Game Design (≈22%); several Development bars (Documentation, Team, Testing, Tools) and Resource/Customer bars (Budget, Marketing, Piracy/Licensing) appear at lower but non‑negligible percentages. Because postmortems mention multiple issues, the bars do not sum to 100% — the chart highlights which problem types recur across the 155 postmortems rather than exclusive failure categories.
...
Takeaway: For a better game design, developers should keep implementation in mind while creating a design, and if an implementation cannot be pictured for a part of the design, contingencies should be made. Key game concepts should also be tested before release so the reactions of the players can be verified.
...
[11] Mike McShaffry and David Graham. Game Coding Complete. 4th edition.
...
[14] Juergen Musil, Angelika Schweda, Dietmar Winkler, and Stefan Biffl. A survey on the state of the practice in video game software development. Technical report, QSE-IFS-10/04, TU Wien, 2010.
...
[19] Ara Shirinian. Dissecting the postmortem. http://gamasutra.com/view/feature/134679/dissecting_the_postmortem_lessons.php. 2015-09-30.
