...
[Image: page6_img_1.png] A full-page pull-quote attributed to Shuvendu Lahiri stating that “perhaps 70%” of merges chose one side of an edit and dropped the other. The quote appears in very large olive‑green sans‑serif type across multiple lines on a white background, with the author’s name in smaller uppercase above and short gray rule bars at the top and bottom. In the article’s context, this emphasized finding explains a major surprise in the training data—many real-world merges are one‑sided, which affected how the researchers curated and modeled merge resolutions.
