...
[Image: page7_img_author_2.png] A color head-and-shoulders portrait photograph of an adult man with short light-brown hair and light facial stubble, facing the camera with a slight smile. He wears a blue collared shirt and is photographed against a soft, out-of-focus blue-gray background; the photo is framed with a thin dark border. The image appears in the magazine’s “About the Authors” section as the second author’s portrait, placed on a cream page with diagonal stripes and an orange vertical tab at the left. The photo visually accompanies the biographical blurb identifying this person as an assistant professor of computer science.
...
[Image: page7_img_author_3.png] A close-up, framed author headshot used in the article’s “About the Authors” section. The cropped photo shows a smiling adult man with short dark hair and fair skin, wearing a dark top; only part of his face and shoulder are visible. A narrow dark border surrounds the rectangular image, and a brick wall is visible in the background. The photograph is placed on a cream background with diagonal pinstripes and a solid orange vertical bar at the left edge of the page.
