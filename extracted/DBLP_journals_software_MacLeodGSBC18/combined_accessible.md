...
![Infographic: Code Reviewing Best Practices](page4_img_1.png)

> **Image description:** A one-page infographic (Figure 2) divided down the center into an Author column (left) and Reviewer column (right) with icons and arrows showing an iterative review flow. The Author side lists labeled practices A1, A2, A5 and A6 (e.g., A1: “Prepare code change for review” with items like “Be conscientious,” “Aim for small, incremental changes,” and “Test/analyze before submitting”; A2: “Select and notify reviewers” with guidance on how many and who to notify; A5: “Respond and iterate” including “Show gratitude” and “Track and confirm suggested changes”; A6: “Commit code change” urging documentation and reflection). The Reviewer side lists R3 and R4 (R3: “Accept and conduct code review” — e.g., “Set dedicated, bounded time,” “Review frequently, fewer changes at a time,” “Focus on core issues first”; R4: “Provide feedback” — e.g., choose communication channels carefully, give constructive reasons for rejections, use tools that provide decision traceability). A bottom Organization section enumerates seven recommendations (build positive review culture, develop/revise policies, count review time, provide appropriate tools, promote checklists, provide training, and monitor bottlenecks), reinforcing that these practices are intended to address the author- and reviewer-facing challenges identified in the paper.
