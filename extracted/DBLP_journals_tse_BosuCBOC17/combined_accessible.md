...
> **Image description:** A small grayscale circular page graphic (ornament/watermark) near the bottom of page 4, appearing as a light circle with subtle concentric shading and no axes, labels, or numeric content. It is a purely decorative element placed between the end of the 'Impact of Code Review on Peer Impressions' text and the start of Section 4 ('Research Method' / 'Participant Selection'), and does not convey study data or findings. The surrounding page text lists the four behavioral constructs (trustworthiness, reliability, perception of expertise, friendship), but the graphic itself is unrelated to those scale items and serves only as a page graphic.
...
![Portrait of Amiangshu Bosu](page20_img_1.png)

> **Image description:** A grayscale head-and-shoulders portrait of an adult person wearing a dark jacket and a light collared shirt, facing the camera with a neutral expression. The rectangular photo is cropped on the left side of the page and is adjacent to columns of biographical text; a decorative page graphic partly overlaps the lower right corner. The image is presented as a formal author portrait accompanying the paper’s biography section.
...
![Portrait of Christian Bird](page20_img_3.png)

> **Image description:** A tightly cropped grayscale head-and-shoulders photograph of a smiling man, showing his face turned slightly toward the camera with teeth visible. He wears a dark collared shirt and is positioned against a textured brick-wall background; the crop emphasizes his face and upper torso. The image is presented as an author biography portrait in the paper (page 20), adjacent to the biographical text.
