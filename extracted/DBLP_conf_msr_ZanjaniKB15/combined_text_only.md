...
[Image: page3_img_2.png] The image shows an XML snippet of an interaction-log entry for BugId 315184 with AttachId 196936 and Attacher name Steffen Pingel. It records an InteractionEvent with EndDate 2011-05-31 and Kind edit, and a StructureHandle that references the source file AbstractTaskRepositoryPage.java. The paper uses records like this (attacher, date, and file path for edit events) to build interaction logs and compute attacher–file measures (I_f, A_f, R_f) for the iHDev developer-recommendation approach.
