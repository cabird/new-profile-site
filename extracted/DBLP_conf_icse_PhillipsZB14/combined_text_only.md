...
[Image: page3_img_table_1.png] Table of the seven interview participants (P1–P7) showing their primary product group and coarse Microsoft experience ranges (column header: “MS Exp. (yrs)”). Participants represent four major product areas: Visual Studio (P1, P4), Windows (P2), Office (P3, P5, P6), and Xbox (P7). Reported experience spans three bands—5–10 years (P4, P6), 10–15 years (P2, P3, P5), and 15–20 years (P1, P7)—with ranges used to protect participant anonymity.
...
[Image: page3_img_table_2.png] A two-column table showing how the 132 survey respondents are distributed across Microsoft divisions. Counts are: Server and Tools 35, Windows and Windows Live 33, Business 25, Other 15, Entertainment and Devices 13, and Online Services 11. Server and Tools (~26.5%) and Windows and Windows Live (~25%) supplied the largest shares (together about 51% of responses), with Business providing ~19% and the remaining divisions contributing the rest.
...
[Image: page4_img_figure_1.png] A left-to-right flow diagram summarizing the three-study research process. On the left is the guiding “Framework (Cohen and Bailey)” listing four team-effectiveness dimensions; an arrow points to an Interviews box labeled “7 engineers.” The interviews feed a centered list of four findings (Role ambiguity; Knowledge sharing; Intergroup dynamics; Build failure management), which then point to a Survey box labeled “132 responses.” An arrow from the survey leads to four implications (Role redefinition; Social knowledge sharing; Intergroup process transparency; Reduce intergroup conflict) and finally to a Focus Group box labeled “8 participants.” The figure makes explicit how the Cohen & Bailey framework structured the interviews, how interview findings were validated and quantified by the 132-response survey, and how those results informed four actionable implications evaluated with an 8-person focus group.
...
[Image: page4_img_table_1.png] The table enumerates the eight anonymized focus-group participants (F1–F8), giving each participant’s primary Microsoft division and a rounded range of Microsoft experience in years. Participants come from four divisions: Business (2 participants), Server and Tools (2), Entertainment and Devices (1), and Windows and Windows Live (3). Experience is concentrated in mid-level ranges (four participants with 10–15 years, three with 5–10 years) with one senior outlier at 25–30 years, indicating the group mixes junior, mid-career, and long-tenured staff to provide diverse perspectives while preserving anonymity.
...
[Image: page5_img_table_1.png] A table of survey responses (proportion answering “frequently” or “very frequently”) showing which tasks Microsoft builders perform most often. The top tasks are running build operations (71%) and developing build automation (68%), followed by managing code flow (52%), desktop build support (49%), and developing desktop build tools (47%). Less frequent duties include product development (30%), hardware management (18%), and testing (9%), illustrating that builders commonly span both operational/project-management and development/automation responsibilities, which supports the paper’s finding of role ambiguity.
...
[Image: page6_img_table_1.png] A survey-derived table reporting how useful and how frequently builders access seven information sources when investigating build failures (percentages reflect respondents who rated items 4–5 on 1–5 scales; survey N=132). Build logs top both lists (92% useful, 92% frequent), followed by tribal knowledge (undocumented experience: 89% useful, 81% frequent), source control history (82% useful, 78% frequent), and lists of new changes (74% useful, 67% frequent). Check-in systems (43% useful, 26% frequent), external context such as email or hallway conversations (42% useful, 32% frequent), and loop/rolling build results (40% useful, 25% frequent) are used much less often, highlighting builders’ strong reliance on logs, version history, and informal “tribal” knowledge.
...
[22] E.-A. Karlsson, L.-G. Andersson, and P. Leion. Daily build and feature development in large distributed projects. In

---

Proceedings of the 2000 International Conference on Software Engineering, pages 649–658. ACM, 2000.

[23] B. Kitchenham and S. Pfleeger. Personal opinion surveys. In F. Shull, J. Singer, and D. Sjøberg, editors, Guide to Advanced Empirical Software Engineering, pages 63–92. Springer London, 2008.
...
[32] M. Nagappan, T. Zimmermann, and C. Bird. Diversity in software engineering research. In Proceedings of the the joint meeting of the European Software Engineering Conference and the ACM SIGSOFT Symposium on The Foundations of Software Engineering (ESEC/FSE), pages 466–476. ACM, 2013.

[33] S. Phillips, G. Ruhe, and J. Sillito. Information needs for integration decisions in the release process of large-scale parallel development. In Proceedings of the 2012 ACM Conference on Computer Supported Cooperative Work, pages 1371–1380. ACM, 2012.

[34] S. Phillips, J. Sillito, and R. Walker. Branching and merging: an investigation into current version control practices. In Proceedings of the International Workshop on Cooperative and Human Aspects of Software Engineering (CHASE), pages 9–15. ACM, 2011.

[35] S. Phillips, T. Zimmermann, and C. Bird. Appendix to understanding and improving software build teams. Technical Report MSR-TR-2014-28, Microsoft Research, 2014. http://research.microsoft.com/apps/pubs/?id=209991.

[36] M. Pirson and D. Malhotra. Foundations of organizational trust: What matters to different stakeholders? Organization Science, 22(4):1087–1104, 2011.

[37] E. Rocco. Trust breaks down in electronic contexts but can be repaired by some initial face-to-face contact. In Proceedings of the ACM CHI 1998 Conference on Human Factors in Computing Systems (CHI), pages 496–502. ACM Press/Addison-Wesley Publishing Co., 1998.

[38] M. Sherif. The Robbers Cave Experiment: Intergroup Conflict and Cooperation. Wesleyan University Press, 1988.

[39] E. Siemsen, S. Balasubramanian, and A. V. Roth. Incentives that induce task-related effort, helping, and knowledge sharing in workgroups. Management Science, 53(10):1533–1550, 2007.

[40] R. Suvorov, M. Nagappan, A. E. Hassan, Y. Zou, and B. Adams. An empirical study of build system migrations in practice: Case studies on KDE and the Linux kernel. In Proceedings of the International Conference on Software Maintenance, pages 160–169, 2012.

[41] T. C. Tubre and J. M. Collins. Jackson and Schuler (1985) revisited: A meta-analysis of the relationships between role ambiguity, role conflict, and job performance. Journal of Management, 26(1):155–169, 2000.

[42] G. D. Venolia, L. Dabbish, J. Cadiz, and A. Gupta. Supporting email workflow. Technical Report MSR-TR-2001-88, Microsoft Research, 2001.

[43] J. M. Wilson, S. G. Straus, and B. McEvily. All in due time: The development of trust in computer-mediated and face-to-face teams. Organizational Behavior and Human Decision Processes, 99(1):16–33, 2006.

[44] T. Wolf, A. Schroter, D. Damian, and T. Nguyen. Predicting build failures using social network analysis on developer communication. In Proceedings of the 2009 International Conference on Software Engineering ’09, pages 1–11. IEEE Computer Society, 2009.