...
[Image: page1_img_1.png] A horizontal continuum bar with four labeled stages: 'None' at the red left end, 'Status Quo' in brown, then 'Goal' and 'Ideal' in progressively darker green at the right. The segment between Status Quo and Goal is overlaid with diagonal hatching and a dashed arrow above it labeled 'Goal for SE Research' pointing from the Status Quo toward the Goal, while short vertical posts mark the stage boundaries. The diagram visually encodes the paper’s point that the community currently sits near the Status Quo and should move rightward toward the Goal (and ultimately the Ideal) in the amount and quality of data and tool sharing.
...
[1] Editorial Policies: Availability of data and materials, 2003. http://www.nature.com/authors/editorial_policies/availability.html.
...
[5] G. Boetticher, T. Menzies, and T. Ostrand. PROMISE Repository of empirical software engineering data. West Virginia University, Department of Computer Science, 2007. http://promisedata.org/.

[6] J. Buckheit and D. Donoho. Wavelab and reproducible research. Lecture Notes on Statistics, 1995.

[7] D. Budgen, 2006. Keynote address, Conference on Software Engineering Education and Training.
...
[11] R. Gentleman and D. Temple Lang. Statistical analyses and reproducible research. Journal of Computational and Graphical Statistics, 16(1):1–23, March 2007.

[12] F. Leisch. Sweave: Dynamic generation of statistical reports using literate data analysis. In W. Härdle and B. Rönz, editors, Proceedings in Computational Statistics (2002), pages 575–580. Physica Verlag, Heidelberg, 2002.

[13] J. Lung, J. Aranda, S. M. Easterbrook, and G. V. Wilson. On the difficulty of replicating human subjects studies in software engineering. In Proceedings of the International Conference on Software Engineering, 2008.

[14] T. Menzies, M. Benson, K. Costello, C. Moats, M. Northey, and J. Richardson. Learning better IV&V practices. Innovations in Systems and Software Engineering, 4(2):169–183, 2008.

[15] L. Osterweil, L. Clarke, M. Evangelist, J. Kramer, D. Rombach, and A. Wolf. The impact project: determining the impact of software engineering research upon practice. ACM SIGSOFT Software Engineering Notes, 25(6):109, 2000.

[16] D. Overbye. In the hunt for planets, who owns the data? New York Times, http://www.nytimes.com/2010/06/15/science/space/15kepler.html, June 14, 2010.

[17] H. A. Piwowar and W. W. Chapman. A review of journal policies for sharing research data. In Proceedings of the 12th International Conference on Electronic Publishing, 2008.

[18] G. Robles. Replicating MSR: A Study of the Potential Replicability of Papers Published in the Mining Software Repositories Proceedings. In Proceedings of the Working Conference on Mining Software Repositories, 2010.

[19] A. Sandage, M. Sandage, and J. Kristian, editors. Galaxies and the Universe, volume IX. University of Chicago Press, 1975.

[20] M. Y. Vardi. More debate, please! Communications of the ACM, 53(1):5–5, 2010.

[21] W. Viscusi and J. Aldy. The value of a statistical life: a critical review of market estimates throughout the world. Journal of Risk and Uncertainty, 27(1):5–76, 2003.

[22] C. Vogeli, R. Yucel, E. Bendavid, L. Jones, M. Anderson, K. Louis, and E. Campbell. Data withholding and the next generation of scientists: results of a national survey. Academic Medicine, 81(2):128–36, 2006.

[23] T. Wolf, A. Schroter, D. Damian, and T. Nguyen. Predicting build failures using social network analysis on developer communication. In Proceedings of the International Conference on Software Engineering, 2009.

[24] A. Ying, K. Ehrlich, H. Li-Te Cheng, T. Frauenhofer, and F. van Ham. Jazz development data: a community perspective. In Proceedings of International Workshop on Infrastructure for Research in Collaborative Software Engineering, 2008.