...
[Image: page6_img_2.png] A 3×4 table comparing mean network measures for developers (n=73) and non-developers (n=1,123) shows developers have substantially larger betweenness and normalized in- and out-degrees. Means: betweenness 0.0114 vs 0.000140, out-degree 0.00666 vs 0.000451, in-degree 0.00794 vs 0.000367 — roughly two orders of magnitude higher for developers. Two-sample t-tests give t-values of 5.07, 8.14 and 7.54 respectively, each with p < 0.001, indicating the differences are statistically significant. (Betweenness is computed as described in the paper; in/out-degrees were normalized by network size.)
