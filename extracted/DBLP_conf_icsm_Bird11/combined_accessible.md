...
> **Image description:** A smoothed estimate of the hazard (instantaneous rate) of being promoted to a core developer as a function of project membership time (x-axis: analysis time in years, 0–5). The curve rises from about 0.001–0.0012 at time zero to a peak near 0.0022–0.0023 around one year, then steadily declines, with a small secondary bump around year three, falling to roughly 0.0005 by year five. This visualization shows that the probability of promotion is highest near the first year of membership and decreases thereafter, with the peak rate roughly double the early and late rates.
