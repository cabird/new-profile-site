...
[Image: page8_img_1.png] Cropped author-bio panel showing a large, bold uppercase name at the top, followed by a short biographical line and a partial contact-email fragment; beneath this is a framed black-and-white headshot with only the top of the portrait visible. The panel sits on a light beige background with diagonal stripes; the name uses a heavy serif display type while the body text uses a lighter face. Overall the image is a typical ‘About the Authors’ profile block from the paper, combining headline, brief bio text, and a small portrait.
...
[Image: page8_img_2.png] A grayscale head-and-shoulders portrait photograph, shown inside a thin black rectangular frame, of a smiling person with straight, shoulder-length hair. The face is centered against a soft, light background; the page’s diagonal striped design and a column of adjacent text are visible at the right edge. This image is one of the author biography photos included on page 8 of the paper.
...
[Image: page8_img_3.png] A grayscale head-and-shoulders portrait of a man looking straight at the camera. He has short, slightly spiky dark hair, rectangular eyeglasses, and wears a dark collared shirt, with a neutral, professional expression. The photograph is framed with a thin dark border and sits against a beige, diagonally striped page background; it is presented as one of the author headshots in the paper’s "About the Authors" section.
...
[Image: page8_img_6.png] A black-and-white, close-cropped head-and-shoulders portrait showing a man with short hair, rectangular eyeglasses, and a slight smile; he has light facial hair around the chin. The photo is presented with a thin dark border and is set against the article’s pale, diagonally striped background; a curtain and an office chair are visible, softly out of focus, behind him. This image is one of the author portraits in the paper’s “About the Authors” section (page 8) and is displayed as a small rectangular thumbnail.
