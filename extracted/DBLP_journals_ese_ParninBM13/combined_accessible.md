...
![Chris Parnin portrait](page42_img_1.png)

> **Image description:** Color photograph used in the paper’s author biographies showing a head-and-shoulders view of a man (unnamed). He wears rectangular eyeglasses, has short tousled hair, and rests his chin on his right fist with a slight, thoughtful smile. He is dressed in a dark jacket over a collared shirt; the background is an indoor, softly out-of-focus setting with vertical wooden panels and indistinct objects.
...
![Head-and-shoulders portrait of Emerson Murphy-Hill](page43_img_1.png)

> **Image description:** A color head-and-shoulders portrait photograph used in the paper’s author biographies (page 43). The subject is an adult wearing dark rectangular eyeglasses and a black polo shirt, with short hair and a slight smile, photographed against a solid red backdrop that contains a faint numeric or patterned motif. The image is tightly framed around the face and upper torso with even, warm lighting and a neutral, professional expression.
