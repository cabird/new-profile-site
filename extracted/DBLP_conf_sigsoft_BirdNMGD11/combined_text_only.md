...
[Image: page7_img_1.png] The schematic shows two binaries as yellow ovals — Foo.exe (top) and Bar.dll (bottom) — linked by a blue arrow labeled “Dependency” from Foo.exe to Bar.dll. A green arrow labeled “Major Contributor” points from a developer (off to the left) to Foo.exe, while a red arrow labeled “Minor Contributor” points from the same developer to Bar.dll, illustrating a developer who is an owner of one component but only a minor contributor to a component it depends on. The paper uses this Major–Minor–Dependency pattern to explain a common maintenance behavior and to motivate the statistical analysis (they found this relationship for 52% of binaries in Vista versus about 24% in randomized graphs).
