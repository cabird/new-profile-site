...
[Image: page5_img_1.png] A personal topic-plot showing the developer’s average commit relevance to two requirements-derived topics over time (legend lists Topic 13: “component set policy context service mode high” and Topic 14: “track structure …”). The x‑axis runs from 2010/04/15 to 2011/06/23 and the y‑axis is labeled “Avg. Commit Relevance” (0.0–2.5). The plot shows almost no topic-relevant activity through mid‑2010, a few small spikes in Sep–Oct 2010, and several much larger, concentrated bursts of relevance in early 2011 (peaking around May 2011 at ≈2.5). These peaks indicate short periods when this developer’s commit messages were strongly related to the shown requirement topics (average relevance per time window), while long flat stretches indicate little or no topic‑related work.
