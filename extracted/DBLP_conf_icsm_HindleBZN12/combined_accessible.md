...
> **Image description:** A schematic three‑column diagram showing how requirements documents (left, paper icons) are transformed into topics (center, rectangular boxes labeled “Topic”) and then linked to commits (right, triangle icons). Thick arrows illustrate many‑to‑many relationships: multiple requirements contribute to each topic, and each topic is associated with multiple commits (and commits can relate to multiple topics). In the paper’s context these topics are LDA‑extracted word distributions from requirements and commits are connected by LDA inference to produce a document–topic matrix used for traceability and time‑series topic plots of development effort.
...
> **Image description:** A grid of 20 small time‑series plots (one per LDA topic) showing how each topic’s average relevance in commits changed from May 2000 to June 2010. Each subplot is a colored filled curve (commit relevance per time window) with a thin black trend line; x‑axes are calendar dates and y‑axes are average topic relevance (scales differ per plot). The plots show distinct behaviors: some topics have sharp early spikes (around 2001–2002), others steadily grow in relevance after ~2007 (for example a topic the authors note rises strongly late in the decade), and still others (e.g., use‑case and testing related topics) decline in prominence over time. Several subplot labels are abbreviated or redacted, and the figure summarizes global, project‑level topic focus inferred from requirements and commit messages across the product lifetime.
...
> **Image description:** A personal topic-plot showing the developer’s average commit relevance to two requirements-derived topics over time (legend lists Topic 13: “component set policy context service mode high” and Topic 14: “track structure …”). The x‑axis runs from 2010/04/15 to 2011/06/23 and the y‑axis is labeled “Avg. Commit Relevance” (0.0–2.5). The plot shows almost no topic-relevant activity through mid‑2010, a few small spikes in Sep–Oct 2010, and several much larger, concentrated bursts of relevance in early 2011 (peaking around May 2011 at ≈2.5). These peaks indicate short periods when this developer’s commit messages were strongly related to the shown requirement topics (average relevance per time window), while long flat stretches indicate little or no topic‑related work.
...
![Topic plots for 2 developers](page7_img_1.png)

> **Image description:** Four time-series plots compare how two topics ('use cases feature' in purple, and 'testing and power' in maroon) map to commit activity for individual developers (left column) and teams (right column) from 2005 to 2011. The x‑axis is time and the y‑axis is average commit relevance (higher = more commits associated with the topic); colored filled areas mark periods when commits were inferred as relevant to the topic. The top pair (purple) shows intermittent spikes of developer activity at different times—one developer with early scattered peaks and the other with a concentrated mid-2006–2007 burst—while the bottom pair (maroon) shows more sustained and higher relevance for testing/power, especially with pronounced peaks around 2008–2010 for the team view. These contrasting patterns illustrate the paper’s point that topic‑relevant effort differs between individuals and teams and that personal topic-plots can reveal when a developer or team focused on a particular requirements topic.

(a) Topic plots of 2 developers

![Topic plots for 2 teams](page7_img_2.png)

> **Image description:** Four small area time-series plots (X axis: time from 2002 to 2011; Y axis: average commit relevance) compare two topics across two teams: the top row shows the topic labeled “testing, metrics and milestones,” and the bottom row shows the topic labeled “music player: volume, song, controls…”. For the testing topic, both teams show concentrated activity in the early period (roughly 2002–2006) with multiple peaks and a clear decline to near-zero relevance by ~2008–2011; the right-hand team’s plot also overlays a downward trend line. For the music-player topic, the left-hand team exhibits many small rises culminating in larger peaks around 2009–2010, whereas the right-hand team has a single sharp spike (around 2006) and otherwise near-zero relevance. The plots use teal shading for the testing topic and magenta for the music-player topic, illustrating how different teams shift their commit focus over time for the same requirements topics.
...
![Bar chart: Rating of Topic-Plot Matching - Perception of Effort](page8_img_1.png)

> **Image description:** Bar chart of survey responses (y-axis: count, x-axis: categories) showing how developers rated whether personal topic-plots matched their perception of effort. The counts shown above each bar are: NA = 3, Strongly Disagree = 3, Disagree = 4, Neutral = 3, Agree = 10, Strongly Agree = 1, with the y-axis scaled to 12. As noted in the paper, the modal response is “Agree” and the reported average rating is about 3.09 (between neutral and agree), indicating a plurality of respondents found the topic-plots reflective of their effort while a nontrivial number disagreed or were neutral.
...
previously made about LDA derived topics and have shown that practitioners can interpret and label topics.
...
[2] N. Tillmann, F. Chen, and W. Schulte, “Discovering likely method specifications,” in Formal Methods and Software Engineering, ser. Lecture Notes in Computer Science, Z. Liu and J. He, Eds. Springer Berlin / Heidelberg, 2006, vol. 4260, pp. 717–736, 10.1007/11901433_39.

[3] J. Cleland-Huang, R. Settimi, O. BenKhadra, E. Berezhanskaya, and S. Christina, “Goal-centric traceability for managing non-functional requirements,” in Proceedings of the 27th international conference on Software engineering, ser. ICSE ’05. New York, NY, USA: ACM, 2005, pp. 362–371.

[4] M. Sabetzadeh and S. Easterbrook, “Traceability in viewpoint merging: a model management perspective,” in Proceedings of the 3rd international workshop on Traceability in emerging forms of software engineering, ser. TEFSE ’05. New York, NY, USA: ACM, 2005, pp. 44–49.

[5] D. M. Blei, A. Y. Ng, and M. I. Jordan, “Latent dirichlet allocation,” J. Mach. Learn. Res., vol. 3, pp. 993–1022, Mar. 2003.

[6] H. U. Asuncion, A. U. Asuncion, and R. N. Taylor, “Software traceability with topic modeling,” in Proceedings of the 32nd ACM/IEEE International Conference on Software Engineering - Volume 1, ser. ICSE ’10. New York, NY, USA: ACM, 2010, pp. 95–104.

[7] P. F. Baldi, C. V. Lopes, E. J. Linstead, and S. K. Bajracharya, “A theory of aspects as latent topics,” in Proceedings of the 23rd ACM SIGPLAN conference on Object-oriented programming systems, languages and applications, ser. OOPSLA ’08. New York, NY, USA: ACM, 2008, pp. 543–562.

[8] T. Savage, B. Dit, M. Gethers, and D. Poshyvanyk, “TopicXP: Exploring topics in source code using latent dirichlet allocation,” in Proceedings of the 2010 IEEE International Conference on Software Maintenance, ser. ICSM ’10. Washington, DC, USA: IEEE Computer Society, 2010, pp. 1–6.

[9] S. W. Thomas, B. Adams, A. E. Hassan, and D. Blostein, “Modeling the evolution of topics in source code histories,” in Proceedings of the 8th Working Conference on Mining Software Repositories, ser. MSR ’11. New York, NY, USA: ACM, 2011, pp. 173–182.

[10] ——, “Validating the use of topic models for software evolution,” in Proceedings of the 2010 10th IEEE Working Conference on Source Code Analysis and Manipulation, ser. SCAM ’10. Washington, DC, USA: IEEE Computer Society, 2010, pp. 55–64.

[11] A. Hindle, N. A. Ernst, M. W. Godfrey, and J. Mylopoulos, “Automated topic naming to support cross-project analysis of software maintenance activities,” in Proceedings of the 8th Working Conference on Mining Software Repositories, ser. MSR ’11. New York, NY, USA: ACM, 2011, pp. 163–172.

[12] B. H. C. Cheng and J. M. Atlee, “Research directions in requirements engineering,” in 2007 Future of Software Engineering, ser. FOSE ’07. Washington, DC, USA: IEEE Computer Society, 2007, pp. 285–303.

[13] B. Ramesh, “Factors influencing requirements traceability practice,” Commun. ACM, vol. 41, no. 12, pp. 37–44, Dec. 1998.

[14] N. Ernst and J. Mylopoulos, “On the perception of software quality requirements during the project lifecycle,” in Requirements Engineering: Foundation for Software Quality, ser. Lecture Notes in Computer Science, R. Wieringa and A. Persson, Eds. Springer Berlin / Heidelberg, 2010, vol. 6182, pp. 143–157, 10.1007/978-3-642-14192-8_15.

[15] G. C. Murphy, D. Notkin, and K. J. Sullivan, “Software reflexion models: Bridging the gap between design and implementation,” IEEE Trans. Softw. Eng., vol. 27, no. 4, pp. 364–380, Apr. 2001.

[16] H. M. Sneed, “Testing against natural language requirements,” in Proceedings of the Seventh International Conference on Quality Software, ser. QSIC ’07. Washington, DC, USA: IEEE Computer Society, 2007, pp. 380–387.

[17] S. P. Reiss, “Incremental maintenance of software artifacts,” IEEE Trans. Softw. Eng., vol. 32, no. 9, pp. 682–697, Sep. 2006.

[18] D. Poshyvanyk, “Using information retrieval to support software maintenance tasks,” Ph.D. dissertation, Wayne State University, Detroit, MI, USA, 2008.

[19] C. McMillan, D. Poshyvanyk, and M. Revelle, “Combining textual and structural analysis of software artifacts for traceability link recovery,” in Proceedings of the 2009 ICSE Workshop on Traceability in Emerging Forms of Software Engineering, ser. TEFSE ’09. Washington, DC, USA: IEEE Computer Society, 2009, pp. 41–48.

[20] S. Konrad and B. Cheng, “Automated analysis of natural language properties for UML models,” in Satellite Events at the MoDELS 2005 Conference, ser. Lecture Notes in Computer Science, J.-M. Bruel, Ed. Springer Berlin / Heidelberg, 2006, vol. 3844, pp. 48–57, 10.1007/11663430_6.

[21] A. Marcus, A. Sergeyev, V. Rajlich, and J. I. Maletic, “An information retrieval approach to concept location in source code,” in Proceedings of the 11th Working Conference on Reverse Engineering, ser. WCRE ’04. Washington, DC, USA: IEEE Computer Society, 2004, pp. 214–223.

[22] S. K. Lukins, N. A. Kraft, and L. H. Etzkorn, “Source code retrieval for bug localization using latent dirichlet allocation,” in Proceedings of the 2008 15th Working Conference on Reverse Engineering, ser. WCRE ’08. Washington, DC, USA: IEEE Computer Society, 2008, pp. 155–164.

[23] A. J. Ko, R. DeLine, and G. Venolia, “Information needs in collocated software development teams,” in Proceedings of the 29th international conference on Software Engineering, ser. ICSE ’07. Washington, DC, USA: IEEE Computer Society, 2007, pp. 344–353.

[24] F. Shull, J. Singer, and D. I. K. Sjöberg, Guide to Advanced Empirical Software Engineering, 1st ed. Springer Publishing Company, Incorporated, 2010.
