...
> **Image description:** A bar chart of ASCII codes 1–127 (x-axis ticked at 1,10,19,…,127) showing total occurrence counts per character across all Eclipse 2.0 files; the y-axis is in millions (0E+0 to 5E+6). The plot is heavily skewed toward printable and blank characters, with the largest peak at the space character (ASCII 32) and prominent peaks in the lower‑case letter region — notably around ASCII 101 ('e') and 116 ('t') — as reported in the paper. Smaller but visible spikes occur at other common characters (e.g., newline around ASCII 10 and clusters for digit/letter codes), illustrating the bias toward 7‑bit printable characters mentioned in the text.
