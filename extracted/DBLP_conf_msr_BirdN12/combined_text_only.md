...
[Image: page6_img_fig1_maps.png] Two side-by-side maps showing where Firefox development activity originated. The left panel is a zoomed map of Europe with blue circles (area proportional to number of commits) marking development hotspots in Western and Northern Europe (e.g., UK/Amsterdam, Switzerland, Sweden, France). The right panel is a world map of contributions specifically for the content-event handling module, with blue markers in North America, Europe and Asia; the paper notes this module was developed across three continents and contributions came from about 16 countries/states. The visual emphasizes that while many commits concentrate in a few locations, development for some modules is globally distributed rather than collocated.
